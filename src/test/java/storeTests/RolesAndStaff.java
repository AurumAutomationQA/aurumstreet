...
public class RolesAndStaff extends ReusableMethods {
    ...
    @Test(priority = 1)
    public void navigateAndValidateRolesAndStaff() {
        startTest("Navigate to Roles and Staff and validate fields");

        click("//span[text()='Dashboard']/..", "dashboard button");
        clickByCSS(".max-xl\\3Ahidden > .w-full", "features expand");
        click("//span[text()='Roles and Staff']", "Roles and Staff link");

        verifyIsDisplayed("//h3[text()='Roles and Staff']", "Roles and Staff heading");
