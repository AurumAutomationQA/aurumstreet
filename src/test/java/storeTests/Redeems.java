...
public class Redeems extends ReusableMethods {
    ...
    @Test(priority = 1)
    public void navigateAndValidateRedeems() {
        startTest("Navigate to Redeems and validate fields");

        click("//span[text()='Dashboard']/..", "dashboard button");
        clickByCSS(".max-xl\\3Ahidden > .w-full", "features expand");
        click("//span[text()='Redeems']", "Redeems link");

        verifyIsDisplayed("//h3[contains(text(),'Redeems')]", "Redeems heading");
