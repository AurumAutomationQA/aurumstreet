...
public class Audience extends ReusableMethods {
    ...
    @Test(priority = 1)
    public void navigateAndValidateAudience() {
        startTest("Navigate to Audience and validate fields");

        click("//span[text()='Dashboard']/..", "dashboard button");
        clickByCSS(".max-xl\\3Ahidden > .w-full", "features expand");
        click("//span[text()='Audience']", "Audience link");

        verifyIsDisplayed("//h3[contains(text(),'Audience')]", "Audience heading");
