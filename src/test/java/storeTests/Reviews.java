...
public class Reviews extends ReusableMethods {
    ...
    @Test(priority = 1)
    public void navigateAndValidateReviews() {
        startTest("Navigate to Reviews and validate fields");

        click("//span[text()='Dashboard']/..", "dashboard button");
        clickByCSS(".max-xl\\3Ahidden > .w-full", "features expand");
        click("//span[text()='Reviews']", "Reviews link");

        verifyIsDisplayed("//h3[text()='Reviews']", "Reviews heading");
