...
public class Stores extends ReusableMethods {
    ...
    @Test(priority = 1)
    public void navigateAndValidateStores() {
        startTest("Navigate to Stores and validate fields");

        click("//span[text()='Dashboard']/..", "dashboard button");
        clickByCSS(".max-xl\\3Ahidden > .w-full", "features expand");
        click("//span[text()='Stores']", "Stores link");

        verifyIsDisplayed("//h3[text()='Stores']", "Stores heading");
