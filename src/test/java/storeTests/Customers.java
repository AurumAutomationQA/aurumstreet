...
public class Customers extends ReusableMethods {
    ...
    @Test(priority = 1)
    public void navigateAndValidateCustomers() {
        startTest("Navigate to Customers and validate fields");
        ...
        verifyIsDisplayed("//h3[contains(text(),'Customers')]", "Customers heading");
